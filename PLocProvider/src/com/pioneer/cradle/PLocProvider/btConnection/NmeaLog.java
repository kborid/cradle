...
//	private static final String TAG = NmeaLog.class.getName();
	...
	private static final NmeaLog instance = new NmeaLog();
	
	private NmeaLog() {
		syncLogEnable();
	}
	
	public static final NmeaLog getInstance() {
		return instance;
	}
		...
		if (m_bWriteLogsToFileEnable) {
			...
			if (mFileNameFlag == false) {
				...
				String date = new java.text.SimpleDateFormat("yyyyMMddHHmmss")
						.format(time1);
				mflieName = FilePath + "nmealog" + date+".txt";
